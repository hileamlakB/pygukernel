...
# kernel path: /tmp/torchinductor_hileamlak/xc/cxcmyfacu3h2qwxzde7xila3zpbhetcxbe6e5o5wh7v53xpd5hyn.py
...
@pointwise(size_hints=[2048], filename=__file__, meta={'signature': {0: '*fp32', 1: '*i1', 2: 'i32'}, 'device': 0, 'constants': {}, 'mutated_arg_names': ['in_out_ptr0'], 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]})
@triton.jit
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty_strided((200, 10), (10, 1), device='cuda', dtype=torch.float32)
        extern_kernels.addmm(primals_2, primals_3, as_strided(primals_1, (3, 10), (1, 3)), alpha=1, beta=1, out=buf0)
        del primals_1
        del primals_2
        buf1 = buf0; del buf0  # reuse
        buf2 = empty_strided((200, 10), (10, 1), device='cuda', dtype=torch.bool)
        stream0 = get_cuda_stream(0)
        triton_fused_relu_threshold_backward_0.run(buf1, buf2, 2000, grid=grid(2000), stream=stream0)
...
def benchmark_compiled_module():
    ...
    primals_3 = rand_strided((200, 3), (3, 1), device='cuda:0', dtype=torch.float32)
